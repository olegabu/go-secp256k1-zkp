...
(() => {
	...
	global.Go = class {
		constructor() {
            ...
            this._mem = new WebAssembly.Memory({ initial: 2048, maximum: 2048 });

			const mem = () => {
			    
				// The buffer may change when requesting more memory.
				return new DataView((this._inst.exports.memory || this._mem).buffer);
			}
			...
			const loadSlice = (array, len, cap) => {
				return new Uint8Array((this._inst.exports.memory || this._mem).buffer, array, len);
			}
			...
			const loadString = (ptr, len) => {
				return decoder.decode(new DataView((this._inst.exports.memory || this._mem).buffer, ptr, len));
			}
		...
		async run(instance) {
            ...
            this._mem = new WebAssembly.Memory({ initial: 2048, maximum: 2048 });
            const mem = new DataView((this._inst.exports.memory || this._mem).buffer);
