...
const (
	...
	MESSAGE_SIZE uint16 = 32

	/// The size (in bytes) of a secret key
	SECRET_KEY_SIZE uint16 = 32
	...
	PUBLIC_KEY_SIZE uint16 = 72

	/// The size (in bytes) of an uncompressed public key
	UNCOMPRESSED_PUBLIC_KEY_SIZE uint16 = 65

	/// The size (in bytes) of a compressed public key
	COMPRESSED_PUBLIC_KEY_SIZE uint16 = 33

	/// The size of an agg sig
	AGG_SIGNATURE_SIZE uint16 = 64

	/// The maximum size of a signature
	MAX_SIGNATURE_SIZE uint16 = 72

	/// The maximum size of a compact signature
	COMPACT_SIGNATURE_SIZE uint16 = 64

	/// The size of a Pedersen commitment
	PEDERSEN_COMMITMENT_SIZE uint16 = 33

	/// The size of a single Bullet proof
	SINGLE_BULLET_PROOF_SIZE uint16 = 675

	MAX_PROOF_SIZE uint16 = 5134

	/// The maximum size of a message embedded in a range proof
	PROOF_MSG_SIZE uint16 = 2048

	/// The maximum size of an optional message embedded in a bullet proof
	BULLET_PROOF_MSG_SIZE uint16 = 16
)

/// The order of the secp256k1 curve
var CURVE_ORDER = [32]byte{
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe,
	0xba, 0xae, 0xdc, 0xe6, 0xaf, 0x48, 0xa0, 0x3b, 0xbf, 0xd2, 0x5e, 0x8c, 0xd0, 0x36, 0x41, 0x41,
}

/// The X coordinate of the generator
var GENERATOR_X = [32]byte{
	0x79, 0xbe, 0x66, 0x7e, 0xf9, 0xdc, 0xbb, 0xac, 0x55, 0xa0, 0x62, 0x95, 0xce, 0x87, 0x0b, 0x07,
	0x02, 0x9b, 0xfc, 0xdb, 0x2d, 0xce, 0x28, 0xd9, 0x59, 0xf2, 0x81, 0x5b, 0x16, 0xf8, 0x17, 0x98,
}

/// The Y coordinate of the generator
var GENERATOR_Y = [32]byte{
	0x48, 0x3a, 0xda, 0x77, 0x26, 0xa3, 0xc4, 0x65, 0x5d, 0xa4, 0xfb, 0xfc, 0x0e, 0x11, 0x08, 0xa8,
	0xfd, 0x17, 0xb4, 0x48, 0xa6, 0x85, 0x54, 0x19, 0x9c, 0x47, 0xd0, 0x8f, 0xfb, 0x10, 0xd4, 0xb8,
}

/// Generator G
var GENERATOR_G = [33]byte{
